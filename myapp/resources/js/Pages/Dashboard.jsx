        ...
        <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
          ...
          <div className="mt-auto p-4 flex justify-center">
            <div className="w-24 h-20 flex items-center justify-center bg-white">
              <img src={appIcon} className="max-h-full max-w-full object-contain" />
            </div>
          </div>
        </aside>
          ...
          <main className="flex gap-6 p-6">
            ...
            <section className="flex-1 flex flex-col gap-4">
              ...
              <div className="border-2 border-dashed border-[#96d7d0] bg-teal-50 rounded-xl p-4 flex justify-center">
                <button className="px-3 py-2 rounded-lg border border-[#009689] text-[#009689]">
                  + Add new job
                </button>
              </div>
            </section>
