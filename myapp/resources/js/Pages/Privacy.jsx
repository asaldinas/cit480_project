...
export default function Privacy() {
    ...
    if (confirm("Are you sure you want to permanently delete your account and related data? This cannot be undone.")) {
        destroy("/profile", {
            preserveScroll: true,
    ...
    <div className="mt-4">
        <button
            ...
            disabled={processing}
            className="rounded-lg border border-red-200 bg-white px-4 py-2 text-sm font-medium text-red-600 transition hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-50"
        >
